<?php $pageTitle="Students | Assignment 4: Odd Student Out"; ?>
...
<nav class=" box menu "><a href="index.php">Back to Brooklyn!</a></nav>
...
<main>
	...
	<img src="images/dewey-bazirake.jpg" alt="Dewey Bazirake">
		...
		<article class="f">
			<div class="headings">
			<h2 class="name">Dewey Bazirake</h2>
			<h3 class="compsci">Computer Science major</h3>
		</div>
	...
	<section class="odd">
		...
		<article class="f">
			<div class="oddhead">
			<h2 class="name">Jialin Huo</h2>
			<h3 class="compsci">Computer Science minor</h3>
		</div>
	...
	<section class="box ">
		...
		<article class="f">
			<div class="headings">
			<h2 class="name">Joshua Wolkoff</h2>
			<h3 class="compsci">Computer Science major</h3>
		</div>
